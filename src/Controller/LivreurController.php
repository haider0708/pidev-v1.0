...
class LivreurController extends AbstractController
{
    ...
    #[Route('/livreurs/search', name: 'livreurs_search')]
    public function search(Request $request, LivreurRepository $livreurRepository,NormalizerInterface $Normalizer)

    {
        ...
        $livreurs = $livreurRepository->search($searchTerm);
        $jsonContent = $Normalizer->normalize($livreurs, 'json', ['groups' => 'livreurs']);
     
        
        return new Response(json_encode($jsonContent));
    }
    #[Route('/triec', name: 'triecroissant')]
    public function trierparNomcroissant(LivreurRepository $repository): Response
    {
      $livreurcroissant=$repository->triecroissant();
        return $this->render('livreur/afficherLivreur.html.twig', [
            "livreurs"=> $livreurcroissant
        ]);

    }
    #[Route('/tried', name: 'triedecroissant')]
    public function trierparnomdecroissant(LivreurRepository $repository): Response
    {
        $livreurdecroissant=$repository->triedecroissant();
        return $this->render('livreur/afficherLivreur.html.twig', [
            "livreurs"=>$livreurdecroissant
        ]);
