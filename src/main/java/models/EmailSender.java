...
public class EmailSender {
    public static void AjoutPharmacieEmail(String userEmail, String test) {
        ...
        try {
            ...
            message.setSubject("Pharmacie Ajoute Avec Succés"); // Objet de l'e-mail
            String emailContent = "Bonjour " + ",\n\n"
                    + "Félicitations ! Votre Pharmacie a ete Cree avec succés\n"
                    + "Merci de votre participation.\n\n"
                    + "Cordialement,\n"
                    + "DEVLAb"; // Contenu de l'e-mail
